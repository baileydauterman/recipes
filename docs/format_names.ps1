...
Clear-Content .\drinks.md
Clear-Content .\desserts.md
...
Add-ToFile -Path .\drinks.md -Data "# Drink Recipes

Drink responsibly mi amigos"
Add-ToFile -Path .\desserts.md -Data "# Dessert Recipes
...
$data | Where-Object Path -match "drinks/" | ForEach-Object {
    $info = "- [$($_.Title)]($($_.Path))"
    Add-ToFile -Path .\_sidebar.md -Data "    $info"
    Add-ToFile -Path .\drinks.md -Data "$info"
}
...
$data | Where-Object Path -match "desserts/" | ForEach-Object {
    $info = "- [$($_.Title)]($($_.Path))"
    Add-ToFile -Path .\_sidebar.md -Data "    $info"
    Add-ToFile -Path .\desserts.md -Data "$info"
}